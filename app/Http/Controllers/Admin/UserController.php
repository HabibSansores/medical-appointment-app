...
class UserController extends Controller
{
    ...
    //Prevenir que un usuario se elimine a si mismo

        if ($user->id === Auth::user()->id) {
            session()->flash('swal', [
                'icon' => 'error',
                'title' => 'Accion denegada',
                'text' => 'No puedes eliminar tu propia cuenta mientras estás autenticado',
            ]);


            abort(403, 'No puedes eliminar tu propia cuenta mientras estás autenticado');
