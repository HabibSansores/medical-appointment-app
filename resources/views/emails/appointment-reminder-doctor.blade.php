...
<body>
    <div class="wrapper">
        <table class="main">
            <tr>
                <td class="header">
                    <h1>⏰ Recordatorio de Paciente</h1>
                    <p>Tiene un paciente agendado para mañana</p>
                </td>
            </tr>
            <tr>
                <td class="content">
                    ...
                    <p>Le recordamos que tiene una consulta programada para <strong>mañana</strong>. Datos del paciente:</p>
                    ...
                    <p>Por favor, revise su agenda y prepare lo necesario para la consulta de mañana.</p>
            ...
            <tr>
                <td class="footer">
                    ...
                    <p>Este es un recordatorio automático generado por el sistema de gestión de citas.</p>
