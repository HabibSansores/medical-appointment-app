        ...
        <form action="{{ route('admin.users.update', $user)}}" method="POST">
            ...
            <div class="space-y-4">
                <div class="grid lg:grid-cols-2 gap-4">
                    ...
                    <x-wire-input label="Correo electronico" name="email" type="email" placeholder="ejemplo@dominio.com" required 
                ...
                <x-wire-input name="address" label="Direccion" required :value="old('address', $user->address)" placeholder="Ej. Calle 123 #432" autocomplete="street-address"></x-wire-input>
